...
if lepchannel == 'ejets':
	scaler = joblib.load('/export/home/jbarkelo/FinalNNmodels/ejetsbothnpart0scaler.pkl')
	ej_json_file = open('/export/home/jbarkelo/FinalNNmodels/ejetsboth2hidnpart0.json','r')
	ej_json = ej_json_file.read()
	ej_json_file.close()
	model = model_from_json(ej_json)
	model.load_weights('/export/home/jbarkelo/FinalNNmodels/ejetsboth2hidnpart0.h5')
	history = pickle.load(open('/export/home/jbarkelo/FinalNNmodels/ejetsboth2hidnpart0-history.pkl','rb'))

elif lepchannel == 'mujets':
	scaler = joblib.load('/export/home/jbarkelo/FinalNNmodels/mujetsbothnpart0scaler.pkl')
	mj_json_file = open('/export/home/jbarkelo/FinalNNmodels/mujetsboth2hidnpart0.json','r')
	mj_json = mj_json_file.read()
	mj_json_file.close()
	model = model_from_json(mj_json)
	model.load_weights('/export/home/jbarkelo/FinalNNmodels/mujetsboth2hidnpart0.h5')
#	model.load_weights('/export/home/jbarkelo/kerasTutorial/tutorialVirtEnv/models/mujetsboth1hidnpart1-progress.h5')
	history = pickle.load(open('/export/home/jbarkelo/FinalNNmodels/mujetsboth2hidnpart0-history.pkl','rb'))
...
btagWP='77'
sig_df = pd.read_pickle('/scratch/jbarkelo/dataframes77/FCNCc.pkl')
# For Combined Neural Network:
sig_df = pd.concat([sig_df, pd.read_pickle('/scratch/jbarkelo/dataframes77/FCNCu.pkl')],ignore_index=1)
...
for bk in bkgs:
        tmpdf = pd.read_pickle('/scratch/jbarkelo/dataframes77/'+str(bk)+'.pkl')
...
npart = ['ph_iso_topoetcone40','ph_pt','ph_mqph_leading_'+btagWP,'ph_mlph_closest','event_m_blnu_'+btagWP,'ph_drqph_closest_'+btagWP,'deltaRbl','event_mwt','event_ST','event_njets','event_w_chi2_'+btagWP,'jet0pt','ph_drlph_leading','lepton_e','met_met','bjet0pt']
